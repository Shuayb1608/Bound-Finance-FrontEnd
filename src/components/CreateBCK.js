  ...
  return (
    <div className="p-3 card-backgorund rounded-lg">
      ...
      <div className="flex flex-col gap-2 mt-3">
        ...
        <input type="text" className="rounded-md  text-14 bg-transparent focus:ring-2 outline-none border py-2 px-3" id="cupIdInputlock" placeholder="Cup ID" />
      ...
      <div className="flex flex-col gap-2 mt-6">
        ...
        <input type="text" className="rounded-md  text-14 bg-transparent focus:ring-2 outline-none border py-2 px-3" id="cupIdInputdraw" placeholder="Cup ID" />
